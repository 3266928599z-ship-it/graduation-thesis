...
| 路径 | 说明 |
|---|---|
| `文献清单-汇总.md` | 开题答辩文献清单总表（中文 16 + 外文 18，含去重、核心精读优先级、已补全元数据） |
| `文献综述-补充文献清单.md` | 文献综述补充清单（按配准/粗配准/精配准/深度学习/焊接视觉分类） |
| `文献PDF/` | 已下载的英文参考文献原文 PDF（9 篇） |
| `文献/` | 已下载的中文参考文献原文 PDF（16 篇） |
...
| `基于立体视觉和YOLO深度学习框架的焊缝识别与机器人路径规划算法_马佳玮.pdf` | 焊接学报, 2024, 45(11): 44-49 |
| `面向工程现场维修的焊接机器人数字孪生技术_高辉.pdf` | 焊接学报, 2024, 45(11): 54-60 |
| `基于3D深度相机的机器人手眼标定方法研究与应用_葛绍强.pdf` | 现代电子技术, 2022, 45(2): 172-176 |
| `非均匀分布三维点云自适应参数混合滤波去噪方法_程谦.pdf` | 计测技术, 2025, 45(5): 10-18 |
| `基于混合滤波的点云去噪算法研究_赵涵.pdf` | 应用激光, 2023, 43(9): 143-151 |
| `基于激光三维视觉传感的焊接机器人焊缝定位与跟踪研究_赵磊.pdf` | 深圳大学硕士论文, 2023 |
